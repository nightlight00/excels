...
using excels.Tiles.Decorations.MusicBoxes;

namespace excels.Items.Placeable.MusicBoxes
{
    internal class NiflheimMusicBox : ModItem
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Music Box (Niflheim)");
			Tooltip.SetDefault("Composed by HBDeus");
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Audio/Music/Boss/niflheim"), ModContent.ItemType<NiflheimMusicBox>(), ModContent.TileType<NiflheimMusicBoxTile>());
		}
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<NiflheimMusicBoxTile>();
			Item.width = 24;
			Item.height = 24;
