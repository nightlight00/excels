...
using excels.Items.Placeable.Decorations.Misc;

namespace excels.Tiles.Decorations.Misc
{
	#region Dev Trophy
	internal class NightLightLampy : ModTile
	{
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 64, ModContent.ItemType<NightLightLamp>());
		}
