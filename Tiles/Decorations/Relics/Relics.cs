...
using excels.Items.Placeable.Decorations.Relics;

namespace excels.Tiles.Decorations.Relics
{
	public class ExcelsiorRelics : ModTile
	{
		public const int FrameWidth = 18 * 3;
		public const int FrameHeight = 18 * 4;
		public const int HorizontalFrames = 1;
		public const int VerticalFrames = 3; // Optional: Increase this number to match the amount of relics you have on your extra sheet, if you choose to go the Item.placeStyle way
		...
		public virtual string RelicTextureName => "excels/Tiles/Decorations/Relics/StellarStarshipBossRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "excels/Tiles/Decorations/Relics/RelicPedestal";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<StellarStarshipRelic>();
					break;
				case 1:
					itemType = ModContent.ItemType<NiflheimRelic>();
					break;
				case 2:
					itemType = ModContent.ItemType<ChasmRelic>();
					break;
		...
		public override void SetDrawPositions(int i, int j, ref int width, ref int offsetY, ref int height, ref short tileFrameX, ref short tileFrameY)
		{
			...
			tileFrameY %= FrameHeight * 3; // Clamps the frameY (two horizontally aligned place styles, hence * 2)
		}
