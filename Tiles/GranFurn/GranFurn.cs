...
namespace excels.Tiles.GranFurn
{
    internal class GranTorchT : ModTile
    {
		...
		public override void SetStaticDefaults()
		{
			...
			ItemDrop = ModContent.ItemType<Items.Furniture.GraniteEne.GranTorch>();
			...
			if (!Main.dedServ)
			{
				flameTexture = ModContent.Request<Texture2D>("excels/Tiles/GranFurn/GranTorchT_Flame");
			}
		}
