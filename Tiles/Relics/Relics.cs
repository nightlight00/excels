...
namespace excels.Tiles.Relics
{
	public class ExcelsiorRelics : ModTile
	{
		...
		public virtual string RelicTextureName => "excels/Tiles/Relics/StellarStarshipBossRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "excels/Tiles/Relics/RelicPedestal";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			{
				case 0:
					itemType = ModContent.ItemType<Items.Furniture.Relics.StellarStarshipRelic>();
					break;
				case 1:
					itemType = ModContent.ItemType<Items.Furniture.Relics.NiflheimRelic>();
					break;
